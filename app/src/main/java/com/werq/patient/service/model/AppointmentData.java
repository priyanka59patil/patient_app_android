...
public class AppointmentData extends BaseObservable implements Parcelable {
    ...
    {
        return "AppointmentData [provider = "+provider+", referral_id = "+referral_id+", appointment_date = "+appointment_date+", created_at = "+created_at+", files = "+files+", schedule_status = "+schedule_status+"]";
    }
